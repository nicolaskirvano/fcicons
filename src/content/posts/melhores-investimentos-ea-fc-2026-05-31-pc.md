---
author: "Icons Market"
pubDatetime: 2026-06-01T01:56:02.000Z
title: "Momentum de Icons no EA FC em 31/05 — PC"
draft: false
featured: true
tags:
  - investimentos
...
**Lotta Schelin** liderou o recorte com **+84,2% em 7d** e +32,1% em 24h. Entre 15 cartas, 15 tinham as duas janelas positivas; a mediana semanal foi **+17,9%**.

Os preços destacados iam de **34k coins** a **210k coins**. O ranking descreve momentum observado naquela data; previsão ausente ou inválida aparece como N/D e não confirma uma compra atual.

![Gráfico de variação em 7 dias para os destaques de Momentum de Icons no EA FC em 31/05 — PC](/charts/melhores-investimentos-ea-fc-2026-05-31-pc.svg)
...
- **Bastian Schweinsteiger (89)** — 114k coins, **+28.8% em 7 dias** (+29.6% em 24h). Preço +42% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.

- **Frank Rijkaard (89)** — 99k coins, **+23.8% em 7 dias** (+16.5% em 24h). Preço +18% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.

- **David Beckham (88)** — 120k coins, **+21.2% em 7 dias** (+26.3% em 24h). Preço em linha com a média de 7 dias (+8%). O dado registrava momentum positivo; uma entrada atual exige nova validação.
...
- [Icons no EA FC em 31/05: altas e baixas — PC](/posts/mercado-ea-fc-2026-05-31-pc/)
