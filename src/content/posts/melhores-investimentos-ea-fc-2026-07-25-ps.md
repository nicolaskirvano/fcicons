...
faq:
  - q: "Qual a melhor carta para investir hoje (25/07/2026) no EA FC?"
    a: "Luis Hernández (86, Icons) lidera, com +36.4% em 7 dias a 103k coins no Console (PS). A lista mede momentum e deve ser confirmada com uma cotação atual antes da compra."
...
> 🔝 **Destaque:** Luis Hernández (86) acumula **+36.4% em 7 dias** a 103k coins; leitura atual: **esticada**.
...
| --- | --- | --- | --- | --- | --- | --- |
| Luis Hernández | 86 | Icons | 103k coins | +39.1% | +36.4% | Esticada |
...
- **Luis Hernández (86)** — 103k coins, **+36.4% em 7 dias** (+39.1% em 24h). Preço +35% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Oliver Kahn (91)** — 124k coins, **+13% em 7 dias** (+8.3% em 24h). Preço +24% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Geoff Hurst (88)** — 72k coins, **+12.8% em 7 dias** (+11.1% em 24h). Preço em linha com a média de 7 dias (+3%). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Marco van Basten (91)** — 105k coins, **+10.5% em 7 dias** (+8.2% em 24h). Preço em linha com a média de 7 dias (+7%). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Didier Drogba (89)** — 74k coins, **+9.4% em 7 dias** (+10.1% em 24h). Preço em linha com a média de 7 dias (+4%). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.
...
Luis Hernández (86, Icons) lidera, com +36.4% em 7 dias a 103k coins no Console (PS). A lista mede momentum e deve ser confirmada com uma cotação atual antes da compra.
